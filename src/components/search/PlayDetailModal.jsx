        ...
        <div className="p-6 space-y-6">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              {edition.collection_title && <div><span className="text-gray-500">مجموعه:</span> <strong>{edition.collection_title}</strong></div>}
            </div>
          </section>
              ...
              <div className="space-y-2">
                {refs.map(ref => (
                  <a key={ref.id} href={ref.url} target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-2 text-sm text-indigo-600 hover:text-indigo-800 truncate" dir="ltr">
